...
LOCK IN | Energy: medium–low | Valence: neutral
...
DRIVE | Energy: high | Valence: neutral to positive (intense, forward-moving)
High-energy momentum music. Workouts, running, driving fast, getting hyped. The defining quality is tempo and forward motion — the music should feel like it is pushing you harder. Genre is irrelevant: aggressive rap, drum and bass, high-tempo EDM, punk rock, power pop all sit here. Distinction from Glow: Drive pushes harder, Glow floats higher. You would never put Drive on at a dinner party, and you would never run a marathon to Glow. Distinction from Edge: Drive says "let's go." Edge says "watch out." If intensity is positive and propulsive — Drive. If intensity comes with darkness or menace — Edge.
...
FEELS | Energy: any | Valence: dark or emotionally complex
Emotionally heavy music at any point on the energy spectrum. Music you put on when you actually want to feel something — to process, reflect, wallow, be moved, sit with sadness or nostalgia or bittersweetness. You do NOT put Feels on in the background. You put it on because you want to engage with the emotion. Covers quiet devastating folk songs to loud cathartic rock to soul-baring hip-hop. Sorting criterion: does the music make you feel something in your chest? Is it reaching for an emotional response rather than serving a functional purpose? If yes — Feels. Typical sounds: ballads, confessional singer-songwriter, sad indie, blues, emotionally heavy hip-hop, orchestral pieces with strong emotional arcs, post-punk with melancholy.
...
Valid category names (use exactly): Lock In, Drive, Glow, Unwind, Feels, Edge, Night
